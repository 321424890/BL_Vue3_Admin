...
type ComponentName = CamelCaseComponentName
...
interface InputComponentProps extends Partial<InputProps> {
  ...
  slots?: {
    prefix?: (...args: any[]) => null
    suffix?: (...args: any[]) => null
    prepend?: (...args: any[]) => null
    append?: (...args: any[]) => null
  }
  style?: CSSProperties
}
interface AutocompleteComponentProps extends Partial<AutocompleteProps> {
  on?: {
...
interface InputNumberComponentProps extends Partial<InputNumberProps> {
  on?: {
...
interface SelectComponentProps extends Omit<Partial<ISelectProps>, "options"> {
  /**
   * 数据源的字段别名
   */
  props?: {
  ...
  slots?: {
    default?: (options: SelectOption[]) => null
    optionGroupDefault?: (item: SelectOption) => null
    optionDefault?: (option: SelectOption) => null
    prefix?: (...args: any[]) => null
    empty?: (...args: any[]) => null
  }
  options?: SelectOption[]
...
interface SelectV2ComponentProps {
  multiple?: boolean
  disabled?: boolean
  valueKey?: string
  size?: ComponentSize
  ...
  options?: SelectOption[]
  slots?: {
    default?: (option: SelectOption) => null
  }
  style?: CSSProperties
}
...
interface SwitchComponentProps extends Partial<SwitchProps> {
  on?: {
...
interface RateComponentProps extends Partial<RateProps> {
  on?: {
...
interface ColorPickerComponentProps extends Partial<ColorPickerProps> {
  on?: {
...
interface TransferComponentProps extends Partial<TransferProps> {
  on?: {
  ...
  slots?: {
    default?: (...args: any[]) => null
    leftFooter?: (...args: any[]) => null
    rightFooter?: (...args: any[]) => null
  }
  style?: CSSProperties
}
...
interface RadioGroupComponentProps extends Partial<RadioGroupProps> {
  options?: RadioOption[]
  /**
   * 数据源的字段别名
   */
...
interface RadioButtonComponentProps extends Partial<RadioButtonProps> {
  options?: RadioOption[]
  /**
   * 数据源的字段别名
   */
...
interface CheckboxGroupComponentProps extends Partial<CheckboxGroupProps> {
...
interface DividerComponentProps extends Partial<DividerProps> {
  on?: {
    change?: (value: number) => void
...
interface DatePickerComponentProps extends Partial<DatePickerProps> {
  on?: {
...
interface FormItemProps extends Partial<ElFormItemProps> {
  style?: CSSProperties
  slots?: {
    default?: (...args: any[]) => null
    label?: (...args: any[]) => null
...
interface UploadComponentProps extends Partial<UploadProps> {
  slots?: {
    default?: (...args: any[]) => null
...
interface TreeSelectComponentProps extends Omit<Partial<SelectComponentProps>, "props" | "on" | "slots"> {
  data?: any[]
  emptyText?: string
  nodeKey?: string
  props?: {
