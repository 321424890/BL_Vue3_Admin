...
<!-- 结合其他样式 -->
<CrystalText textOverflow="ellipsis" maxWidth="300px" type="primary" bold>
...
```vue
<CrystalText copyable @copy="handleCopy" @copy-error="handleCopyError">
  点击复制这段文字
</CrystalText>
...
```vue
<template>
  <CrystalText class="custom-text"> 自定义样式的文本 </CrystalText>
</template>
