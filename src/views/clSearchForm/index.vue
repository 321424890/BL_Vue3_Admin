<template>
  <div class="clsearchform-demo-container">
    <!-- 页面头部 -->
    <div class="demo-header">
      <h1 class="demo-title">ClSearchForm 动态搜索表单组件</h1>
      <p class="demo-description">基于 Crystal UI 的动态搜索表单组件，支持多种表单控件类型，可通过配置快速生成搜索表单</p>
    </div>
    ...
    <div class="demo-content">
      ...
      <div class="demo-section">
        ...
        <div class="demo-card">
          ...
          <ClSearchForm :query-config="basicQueryConfig" @search="handleBasicSearch" @reset="handleBasicReset" />
      ...
      <!-- <div class="demo-section">
        ...
        <div class="demo-card">
          ...
          <ClSearchForm :query-config="remoteQueryConfig" @search="handleRemoteSearch" @reset="handleRemoteReset" />
          <div class="form-result">
            <h5>搜索结果：</h5>
...
const remoteQueryConfig = ref([
  {
    ...
    props: {
      ...
      "remote-method": async (query: string) => {
