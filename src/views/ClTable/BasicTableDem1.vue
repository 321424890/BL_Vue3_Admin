  ...
  <div id="printArea" class="flex-column-page-wrap pageWrap">
    ...
    <div class="page-header">
      <div class="header-content">
        <h1 class="page-title">CrystalTable 基础排序筛选表格示例</h1>
        <p class="page-description">基于 Element Plus 表格组件封装的增强型表格组件，提供了基础的表格数据展示功能</p>
      </div>
    </div>
    <!-- 带默认排序和过滤的表格示例 -->
    <el-row :gutter="24">
      <el-col :xs="24" :sm="24" :md="24" :lg="24">
        <div class="input-group">
          <h4>带默认排序和过滤的表格</h4>
          <p>这是一个带默认排序和过滤的表格示例，展示了如何为表头字段默认添加排序和过滤功能。</p>
          <p>ID 字段默认带排序功能，姓名字段默认带过滤功能。</p>
          <CrystalTable :table-data="tableData" :columns="columnsWithSortAndFilter" border stripe />
        </div>
      </el-col>
    </el-row>
  </div>
...
const columnsWithSortAndFilter = ref([
  { prop: "id", label: "ID", width: "80", align: "center", sortable: "custom" },
  { prop: "name", label: "姓名", width: "120", align: "center", filterable: true },
