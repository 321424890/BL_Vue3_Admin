  ...
  <div id="printArea" class="flex-column-page-wrap pageWrap">
    ...
    <div class="page-header">
      <div class="header-content">
        <h1 class="page-title">CrystalInputTag 组件</h1>
        <p class="page-description">
          基于 Element Plus CrystalInputTag 封装的增强型标签输入组件，支持所有 CrystalInputTag 属性和扩展功能
        </p>
      </div>
    </div>
    ...
    <div class="component-docs">
      <h3>CrystalInputTag 组件文档</h3>

      <div class="doc-section">
        <h4>支持的属性</h4>
        <p>CrystalInputTag 组件支持 Element Plus CrystalInputTag 的所有属性：</p>
        <BasicTable
      ...
      <div class="doc-section">
        <h4>支持的事件</h4>
        <p>CrystalInputTag 组件支持 Element Plus CrystalInputTag 的所有事件：</p>
        <BasicTable
