	...
	<div id="printArea" class="flex-column-page-wrap pageWrap">
		...
		<div class="page-header">
			<div class="header-content">
				<h1 class="page-title">BLInputNumber 组件</h1>
				<p class="page-description">基于 Element Plus ElInputNumber 封装的增强型数字输入组件，支持所有 ElInputNumber 属性和扩展功能</p>
			</div>
		</div>
		...
		<div class="input-container">
			<div class="input-group">
				<h4>基本用法</h4>
				<BLInputNumber v-model="number1" :controls="false" placeholder="请输入数字" @change="handleChange" />
			</div>

			<div class="input-group">
				<h4>带范围限制</h4>
				<BLInputNumber v-model="number2" :min="1" :max="10" placeholder="1-10之间的数字" />
			</div>

			<div class="input-group">
				<h4>带步长</h4>
				<BLInputNumber v-model="number3" :step="0.5" placeholder="步长为0.5" />
			</div>

			<div class="input-group">
				<h4>不同尺寸</h4>
				<BLInputNumber v-model="number4" :min="0" :max="100" size="small" style="margin-right: 20px" />
				<BLInputNumber v-model="number5" :min="0" :max="100" size="default" style="margin-right: 20px" />
				<BLInputNumber v-model="number6" :min="0" :max="100" size="large" />
			</div>

			<div class="input-group">
				<h4>禁用状态</h4>
				<BLInputNumber v-model="number7" :min="0" :max="100" disabled />
			</div>

			<div class="input-group">
				<h4>只读状态</h4>
				<BLInputNumber v-model="number8" :min="0" :max="100" readonly />
			</div>

			<div class="input-group">
				<h4>无控制按钮</h4>
				<BLInputNumber v-model="number9" :min="0" :max="100" :controls="false" placeholder="只能手动输入" />
			</div>

			<div class="input-group">
				<h4>自定义范围提示</h4>
				<BLInputNumber v-model="number10" :min="0" :max="100" range-tip="数值必须在0-100之间" @range-exceed="handleRangeExceed" />
			</div>

			<div class="input-group">
				<h4>千分位分隔符</h4>
				<BLInputNumber v-model="number11" :min="0" :max="1000000" :precision="2" thousands />
			</div>
		...
		<div class="component-docs">
			<h3>BLInputNumber 组件文档</h3>

			<div class="doc-section">
				<h4>支持的属性</h4>
				<p>BLInputNumber 组件支持 Element Plus ElInputNumber 的所有属性：</p>
				<BasicTable
			...
			<div class="doc-section">
				<h4>支持的事件</h4>
				<p>BLInputNumber 组件支持 Element Plus ElInputNumber 的所有事件：</p>
				<BasicTable
...
import { ref } from 'vue'
import BLInputNumber from '@/components/BasicInput/inputnumber/index.vue'
